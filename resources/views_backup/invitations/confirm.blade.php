...
<body
    ...
    <div class="w-full max-w-md animate-fade-in-up">
        ...
        {{-- Logo --}}
        <div class="flex flex-col items-center justify-center px-4 py-6 gap-3 animate-fade-in-up-delay">
        ...
        <div
            ...
            <div class="px-6 py-6">
                ...
                <div
                    ...
                    <div
                        class="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-violet-100 to-purple-100
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    {{-- Gabung --}}
                    <form action="{{ route('workspaces.invite.accept', $workspace) }}" method="POST" class="flex-1">
                        @csrf
                    ...
                    {{-- Tolak --}}
                    <form action="{{ route('workspaces.invite.decline', $workspace) }}" method="POST" class="flex-1">
                        @csrf
                        <input type="hidden" name="token" value="{{ $token }}">
                        <button type="submit"
