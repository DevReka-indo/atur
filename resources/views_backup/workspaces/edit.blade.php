    ...
    <div class="min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <nav class="flex items-center gap-2 text-sm text-gray-500 mb-6" aria-label="Breadcrumb">
                ...
                <a href="{{ route('workspaces.show', $workspace) }}" class="hover:text-indigo-600 transition-colors"> View
                    Workspaces</a>
                <i class="fa-solid fa-chevron-right text-xs text-gray-400"></i>
            ...
            <div
                ...
                <div class="p-6 sm:p-8">
                    ...
                    <div class="flex items-center gap-3 mb-6 p-4 bg-gray-50/80 rounded-xl border border-gray-200/60">
                        ...
                        <div>
                            <p class="text-xs text-gray-500 uppercase tracking-wide">Nama Workspace </p>
                    ...
                    <form method="POST" action="{{ route('workspaces.update', $workspace) }}" class="space-y-6">
                        ...
                        <div>
                            <label for="name"
                                class="flex items-center gap-2 block text-sm font-semibold
                                                     text-gray-800 mb-2">
                            ...
                            <p class="mt-1.5 text-xs text-gray-500 flex items-center gap-1">
                                ...
                                The name will be displayed across the workspace and URL.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <textarea name="description" id="description" rows="4"
                                    placeholder="Jelaskan tujuan, anggota tim, atau fokus workspace ini..."
                        ...
                        {{-- Info Box --}}
                        <div
                            class="flex items-start gap-3 p-4 bg-indigo-50/80 border border-indigo-200/60
                                    rounded-xl text-sm text-indigo-800">
                            <i class="fa-solid fa-lightbulb mt-0.5 flex-shrink-0"></i>
                            <div>
                                <p class="font-medium">The changes will be applied immediately</p>
                                <p class="text-indigo-700/90 mt-0.5">
                                    All workspace members will see this update in real-time.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-100">
                            <button type="submit"
                                class="group inline-flex items-center justify-center px-6 py-3 text-white
                                       font-semibold rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600
                                       hover:from-indigo-700 hover:to-violet-700
                                       shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50
                                       transition-all duration-300 transform hover:-translate-y-0.5
                                       focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                <i class="fa-solid fa-check mr-2 transition-transform group-hover:scale-110"></i>
                                Update Workspace
                            </button>
