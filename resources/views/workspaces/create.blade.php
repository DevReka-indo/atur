    ...
    <div class="fixed inset-0 bg-gradient-to-br from-gray-50 to-gray-100/50 -z-10"></div>
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600 ml-13">Create a new workspace to start collaborating with your team.</p>
            </div>
            ...
            <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200/60
                ...
                <div class="p-6 sm:p-8">
                    <form method="POST" action="{{ route('workspaces.store') }}" class="space-y-6">
                        ...
                        {{-- Name Field --}}
                        <div>
                            <label for="name" class="flex items-center gap-2 block text-sm font-semibold text-gray-800 mb-2">
                            ...
                            <div class="relative">
                                <input type="text"
                                    ...
                                    required
                                    autofocus>
                                <i class="fa-regular fa-signature absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"></i>
                            </div>
                            @error('name')
                        ...
                        {{-- Description Field --}}
                        <div>
                            <label for="description" class="flex items-center gap-2 block text-sm font-semibold text-gray-800 mb-2">
                            ...
                            <div class="relative">
                                <textarea name="description"
                                        id="description"
                                        rows="4"
                                        placeholder="Describe the purpose, team members, or focus of this workspace..."
