                    ...
                    <form method="POST" action="{{ route('management-users.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}"
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all duration-200 @error('email') border-red-400 bg-red-50/50 @enderror"
                                required>
                            @error('email')
                                <div class="mt-2 text-sm text-red-600 bg-red-50 border border-red-200 rounded-lg px-3 py-2">
                                    {{ $message }}
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" id="password" name="password" placeholder="At least 6 karakter"
                                    class="w-full px-4 py-3 pr-11 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all duration-200 @error('password') border-red-400 bg-red-50/50 @enderror"
                                    required>
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-100">
                            <button type="submit"
                                class="inline-flex items-center justify-center px-6 py-3 text-white font-semibold rounded-xl bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-500/30 transition-all duration-300 transform hover:-translate-y-0.5">
                                Add User
                            </button>
