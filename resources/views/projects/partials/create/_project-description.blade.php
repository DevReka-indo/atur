...
<section aria-labelledby="project-description-title">
    <div class="mb-5 flex items-start gap-3">
        {{-- <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-emerald-100 text-emerald-700">
            <i class="fa-solid fa-align-left"></i>
        </div> --}}
        <div>
            <h2 id="project-description-title" class="text-base font-semibold text-gray-900">Project Description</h2>
    ...
    <textarea id="description" name="description" rows="5"
        ...
        class="w-full resize-none rounded-xl border border-gray-300 px-4 py-3 transition-all duration-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/50 @error('description') border-red-400 bg-red-50/50 @enderror">{{ old('description') }}</textarea>
    @error('description')
