<div class="relative group">
    <button
        type="button"
        class="inline-flex cursor-pointer items-center gap-2 rounded-xl border border-gray-200 bg-white
            px-4 py-2.5 text-sm font-medium text-gray-600 shadow-sm transition-all duration-200 hover:bg-gray-50"
    >
    ...
    <div
        class="invisible absolute right-0 z-50 mt-1 w-40 rounded-xl border border-gray-100 bg-white
            opacity-0 shadow-lg transition-all duration-200 group-hover:visible group-hover:opacity-100"
    >
        <a
        ...
        <a
            ...
            class="flex items-center gap-2 border-y border-gray-100 px-4 py-2.5 text-sm transition-colors
                {{ $currentView === 'gantt'
                    ? 'bg-indigo-50 font-semibold text-indigo-600'
                    : 'text-gray-600 hover:bg-gray-50' }}"
        >
