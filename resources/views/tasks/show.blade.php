...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="{ showDeleteModal: false }">
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
        ...
        <div class="flex gap-3">
            @if($canContribute)
                <a href="{{ route('tasks.edit', $task) }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg"><i class="fa-solid fa-pen-to-square mr-2"></i>Edit</a>
            @endif
            @if($isManager)
                <button @click="showDeleteModal = true" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg"><i class="fa-solid fa-trash mr-2"></i>Delete</button>
            @endif
        </div>
    </div>
